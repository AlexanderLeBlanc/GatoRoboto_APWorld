...
def set_rules(world: GatoRobotoWorld):    
    ...
    set_rule(world.get_location(LocationName.cartridge_3), 
             lambda state: state.has(ItemName.progressive_treadmill, world.player, 3) or (world.options.rocket_jumps and state.has(ItemName.module_coolant, world.player)))
    ...
    set_rule(world.get_location(LocationName.cartridge_6), 
            lambda state: state.has(ItemName.module_spinjump, world.player) and state.has(ItemName.progressive_treadmill, world.player, 3))
