...
modules_item_data_table: Dict[str, GatoRobotoItemData] = {
    ...
    ItemName.module_hopper: GatoRobotoItemData(gato_roboto_base_id + 214, ItemClassification.useful),
...
item_data_table: Dict[str, GatoRobotoItemData] = {
    **modules_item_data_table, 
    ItemName.cartridge: GatoRobotoItemData(gato_roboto_base_id + 217, ItemClassification.useful),
    ...
    ItemName.hottubes_event: GatoRobotoItemData(gato_roboto_base_id + 1, ItemClassification.progression),
